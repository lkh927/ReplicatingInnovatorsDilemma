...
load CheckPi_GreaterDemand.mat;   % Profit (t, type, N_old, N_both, N_new)
...
%x0 = [0.26960343 3.18345446 7.30125019];
x0 = [1.90263591 2.26817898 10.46420205];
%x0 = [1 1 1];
...
%Theta = [-0.147362421730779 1.24394591815957 2.25381667717391]
...
% Finish
save (MLEresults_GreaterDemand.mat, 'V', 'Policy');
diary off;